...
export class MailService {
  ...
  async sendPasswordChangedNotification(
    ...
    try {
      ...
      console.log(
        'Correo de notificación de cambio de contraseña enviado:',
        result,
      );
    } catch (error) {
      console.error(
        'Error enviando notificación de cambio de contraseña:',
        error,
      );
      throw error;
    }
  ...
  async sendSimpleTextEmail(email: string, message: string) {
    try {
      ...
      console.log('Correo simple enviado:', result);
    } catch (error) {
      console.error('Error enviando correo simple:', error);
      throw error;
    }
  }
}
